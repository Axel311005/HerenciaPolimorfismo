...
namespace PruebaHerencia
{
    public class EmpleadoBaseMasComision2 : EmpleadoPorComision
    {
        ...
        public EmpleadoBaseMasComision2(string nombre, string apellido, string nss, decimal tarifa, decimal venta, decimal salario)
        ...
        {
            return string.Format("{0} {1}\n{2}: {3:C}","Salario base +",base.ToString(), "salario Base", SalarioBase);
        }
