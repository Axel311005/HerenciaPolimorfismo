    ...
    public class EmpleadoPorComision
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}: {1} {2}\n{3}: {4}\n"+
                "{5}: {6:C}\n{7}: {8:F2}", "empleado por comision", PrimerNombre, ApellidoPaterno, "numero seguro social", 
                NumeroSeguroSocial, "ventas brutas", VentasBrutas, "tarifa por comision", TarifaComision);
        }
